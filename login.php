	...
	<body>
		...
		<div class = "garis"><hr></div></br>
				<?php
                        ...
                        if (!empty($_GET['error'])) {
							if ($_GET['error'] == 1) {
                            echo '<h3 style="color: red; text-align:center;">Username atau Password belum terdaftar!</h3>';
                            }
                        }
                ?>
			<div style = "position:absolute; margin-top:20px; margin-left:50px; width:500px;"><h3></h3><br>
				<form name="input_data" action="otentikasi.php" method="post" autocomplete = "on">	
                    <table border="0" cellpadding="5" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                <td><input type="text" name="email" value="" style="width:390px; height: 25px; font-size: 20px;"required></td></tr>
                            <tr>
                                <td>Password</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="right"><input style="border-radius: 5px; padding: 10px; background: green; font-family: Estrangelo Edessa; font-weight: bold; font-size: 17px;" type="submit" name="submit" value="Masuk" /></td>
                            </tr>
                        </tbody>
                    </table>
		</form>
